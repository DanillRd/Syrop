...
<head>
    ...
    <title>Surope - Electronics eShop </title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8 col-12">
                            <ul class="tm-header-info">
                                <li><a href="tel:1111111111"><i class="ion-ios-telephone"></i>1-111-111-1111</a></li>
                            ...
                            <div class="col-lg-7 col-md-8 col-12">
                                <div class="tm-heroslider-contentwrapper">
                                    <div class="tm-heroslider-content">
                                        <h1>People Electronics Collection</h1>
                                        <p>Electronics may be made from a wide range of materials.</p>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="tm-product tm-scrollanim">
                                ...
                                <div class="tm-product-bottomside">
                                    <h6 class="tm-product-title"><a href="product-details.html">Specialized 
                                            order</a></h6>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-12 order-2 order-lg-1">
                            <div class="tm-offer-content">
                                ...
                                <h1>Brand ear eBook on <span>$250</span> only</h1>
                                <div class="tm-countdown" data-countdown="2023/10/12"></div>
                    ...
                    <div class="row tm-blog-slider">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="tm-blog tm-scrollanim">
                                ...
                                <div class="tm-blog-content">
                                    <h6 class="tm-blog-title"><a href="blog-details.html">Service with the best reviews</a></h6>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="tm-blog tm-scrollanim">
                                ...
                                <div class="tm-blog-content">
                                    <h6 class="tm-blog-title"><a href="blog-details.html">Product ring is worn on top of
                                            the
                    ...
                    <div class="widgets widgets-footer row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="single-widget widget-info">
                                ...
                                <ul>
                                    <li><b>Address :</b>0000 Kiev street Name, UA, Ukraine</li>
                                    <li><b>Phone :</b><a href="tel:+111111111">1-111-111-1111</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="single-widget widget-newsletter">
                    ...
                    <form id="tm-mailchimp-form" class="widget-newsletter-form" method="POST" action="process_form.php">
                        <input id="mc-email" type="email" name="mc-email" placeholder="Enter email address">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-7">
                            <p class="tm-footer-copyright">©
                                2023. Designed by <a href="https://github.com/DanillRd">DanillRd</a></p>
                        </div>
                        <div class="col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="tm-prodetails-content">
                                            <h4 class="tm-prodetails-title"></h4>
